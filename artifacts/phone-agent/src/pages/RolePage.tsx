...
import { MessageCircle, User, Building2, ArrowRight, Loader2 } from 'lucide-react';
...
export function RolePage() {
  ...
  const handleConfirm = async () => {
    ...
    setError(null);
    try {
      await setAccountRole(selected === 'service');
      // Re-fetch the user so AuthContext reflects the new isService + needsRoleSetup values
      await refresh();
      navigate('/contacts');
    } catch {
