...
export function SignupPage() {
  const handleSignup = () => {
    // Same Google OAuth flow — the backend upserts the user on first sign-in,
    // so "sign up" and "sign in" are the same action.
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-[22px] border border-card-border bg-card p-8 shadow-sm">
          ...
          <p className="mt-4 text-center text-[11px] text-muted-foreground">
            By continuing, you agree to let phone agent access your Google Calendar to sync tasks.
          </p>
        </div>
